...
setInterval(function () {
  ...
  if (de.value == "USD" && para.value == "BRL") {
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 5.4).toFixed(2).replace('.', ',');
      simbolo.innerText = "R$";
    }
  }
  ...
  //Dolar para Euro
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 0.84).toFixed(2).replace('.', ',');
      simbolo.innerText = "€";
    }
  }
  ...
  //Real para Euro
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 0.15).toFixed(2).replace('.', ',');
      simbolo.innerText = "€";
    }
  }
  ...
  //Euro para dolar
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 1.19).toFixed(2).replace('.', ',');
      simbolo.innerText = "$";
    }
  }
  ...
  //Euro para Real
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 6.6).toFixed(2).replace('.', ',');
      simbolo.innerText = "R$";
    }
  }
